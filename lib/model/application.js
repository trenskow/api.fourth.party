...
Application.create = async (application) => {
	...
	let apiKey = await newApplication.generateKey();

	await sgMail.send({
		to: newApplication.contact.email,
		from: '"fourth.party" <noreply@fourth.party>',
		subject: 'Your API Key',
		text: `Hi ${newApplication.contact.name}\r\n\r\nHere is your fourty.party API key:\r\n\r\n${apiKey}\r\n\r\nEnjoy!\r\nfourth.party`
	});
